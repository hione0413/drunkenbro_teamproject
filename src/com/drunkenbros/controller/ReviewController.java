...
public class ReviewController {
	...
	public ModelAndView goReport(HttpServletRequest request) {
		...
		String alcoholName = request.getParameter("alcoholName");
		System.out.println("▶ 신고가 들어온 reviewTitle : "+reviewTitle);
		System.out.println("▶ 신고가 들어온 alcoholName : "+alcoholName);
		mav.addObject("reviewTitle",reviewTitle);
		mav.addObject("alcoholName",alcoholName);
